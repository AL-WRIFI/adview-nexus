          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground dark:text-neutral-300 text-sm">info@mix-syria.com</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-5 w-5 text-primary flex-shrink-0" />
                <span className="text-muted-foreground dark:text-neutral-300 text-sm">+963 900 000 000</span>
              </li>
            </ul>
